export interface GHLCountry {
  name: string;
  code: string;
}

export const GHL_COUNTRIES: GHLCountry[] = [
...
export const PRIMARY_COUNTRY_NAMES = ['Australia', 'Canada', 'New Zealand', 'United Kingdom', 'United States'];

export const OTHER_COUNTRIES = GHL_COUNTRIES.filter(
  (c) => !PRIMARY_COUNTRY_NAMES.includes(c.name)
);
...
export const DIAL_CODES: Record<string, string> = {
  ...
  CN: '+86', CO: '+57', KM: '+269', CG: '+242', CR: '+506',
...
const APP_COUNTRY_TO_ISO: Record<string, string> = {
  Australia: 'AU',
  Canada: 'CA',
  'New Zealand': 'NZ',
  UK: 'GB',
...
export function getDialCodeForCountry(appCountry?: string, otherCountryCode?: string): string {
  if (appCountry === 'Other' && otherCountryCode) {
    return DIAL_CODES[otherCountryCode] || '+1';
  }
  const iso = APP_COUNTRY_TO_ISO[appCountry || ''];
  if (iso) return DIAL_CODES[iso] || '+1';
  return '+1';
}
