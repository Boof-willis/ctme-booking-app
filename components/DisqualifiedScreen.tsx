...
import { trackCourseClick, trackDisqualified } from '@/lib/tracking';
...
export default function DisqualifiedScreen({ reason = 'region', utmParams }: DisqualifiedScreenProps) {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl sm:text-[28px] font-bold text-white mb-3">
        Good news: you probably don&apos;t need us
      </h1>

      <p className="text-zinc-400 text-sm sm:text-base max-w-md leading-relaxed mb-6">
        Our done-for-you service starts at ${MINIMUM_ENGAGEMENT_USD.toLocaleString()} and is built for
        larger, messier histories. Based on what you shared, that&apos;s more than you need to spend.
      </p>

      <div className="w-full max-w-md rounded-none border border-[#beb086]/30 bg-[#beb086]/5 p-5 mb-6 text-left">
